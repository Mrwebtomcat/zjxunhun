						...
						<el-col :span="17" class="uerlistbg">
												...
												<ul>
													...
													<li style="width: 12%;">
														 <el-select v-model="form.worke" size="small" placeholder="工作">
															  <el-option label="IT工程师" value="18"></el-option>
															  <el-option label="服务业" value="22"></el-option>
															  <el-option label="工人" value="26"></el-option>
															  <el-option label="白领" value="26"></el-option>
														</el-select>
								...
								<div class="userboxs">
									  <div class="useritem" @click.stop="showDetail('小小与')">
												<el-row :gutter="24">
													<el-col :span="10">
														<img src="https://photo.zastatic.com/images/photo/354163/1416651642/3997368673413261.jpg?scrop=1&crop=1&cpos=north&w=150&h=150" alt="">
													</el-col>
													<el-col :span="14">
						...
						<el-col :span="7">
							...
							<div class="notice_info">
								<div class="vipuserinfo">
									<div class="box">
											<img src="https://photo.zastatic.com/images/photo/468716/1874862312/525887448369577.png?scrop=1&crop=1&cpos=north&w=150&h=150" alt="">
											<div class="icon_vip">
